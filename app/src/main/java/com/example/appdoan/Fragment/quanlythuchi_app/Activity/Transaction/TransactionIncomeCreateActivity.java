...
public class TransactionIncomeCreateActivity extends AppCompatActivity {
    ...
    List<CategoryModel> mListCategoryIncome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_income_create);
        btnBack = findViewById(R.id.btnBack);
        spnCard = findViewById(R.id.cardCreateIncome);
        spnCategory = findViewById(R.id.categoryCreateIncome);
        edtTranName = findViewById(R.id.transactionIncomeNameCreate);
        edtTranAmount = findViewById(R.id.transactionIncomeAmountCreate);
        edtTranLocation = findViewById(R.id.transactionIncomeLocationCreate);
        edtTranDes = findViewById(R.id.transactionIncomeDescriptionCreate);
        edtTranDate = findViewById(R.id.transactionIncomeDateCreate);
        btnTranCreate = findViewById(R.id.btnTransactionIncomeCreate);
        ...
        call.enqueue(new Callback<List<CategoryModel>>() {
            ...
            public void onResponse(Call<List<CategoryModel>> call, Response<List<CategoryModel>> response) {
                if(response.isSuccessful())
                {
                    ...
                    ArrayAdapter<String> categoryName = new ArrayAdapter<>(TransactionIncomeCreateActivity.this, android.R.layout.simple_spinner_item, mListCategoryName);
        ...
        call1.enqueue(new Callback<List<CardModel>>() {
            ...
            public void onResponse(Call<List<CardModel>> call, Response<List<CardModel>> response) {
                if(response.isSuccessful())
                {
                    ...
                    ArrayAdapter<String> cardName = new ArrayAdapter<>(TransactionIncomeCreateActivity.this, android.R.layout.simple_spinner_item, mListCardName);
    ...
    private void setEvent() {
        edtTranDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TransactionIncomeCreateActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btnTranCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(TransactionIncomeCreateActivity.this, "Vui lòng điền đầy đủ thông tin!", Toast.LENGTH_SHORT).show();
                }
                else {
                        ...
                        public void onResponse(Call<ApiResponse<Object>> call, Response<ApiResponse<Object>> response) {
                            if(response.isSuccessful())
                            {
                                ...
                                if(apiResponse.getStatus() == 101)
                                {
                                    ...
                                    Intent intent = new Intent(TransactionIncomeCreateActivity.this, TransactionIncomeActivity.class);
